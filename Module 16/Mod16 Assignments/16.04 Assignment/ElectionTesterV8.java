...
public class ElectionTesterV8 {
	...
	public static void DeletePosition(List<Candidate> array, int position, String name, int votes) {

		array.remove(position);
	}

	public static void DeleteName(List<Candidate> array, String find, String name, int votes) {
